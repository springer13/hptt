#ifndef STRANSPOSE_210_96X9216X96_H
#define STRANSPOSE_210_96X9216X96_H
#include <xmmintrin.h>
#include <immintrin.h>
#include <complex.h>
...
void sTranspose_210_96x9216x96( const float* __restrict__ A, float* __restrict__ B, const float alpha, const float beta, const int *lda, const int *ldb)
{
   int lda1;
   int lda2;
   if( lda == NULL ){
